...
// Services using anyOf (twitter, github, table-insights) are intentionally omitted
...
const _inputSchemaMap = {
    ...
    '/api/json-validate':     { required: ['json'] },
    ...
    '/api/code':              { required: ['language', 'code'] },
    '/api/code-review':       { required: ['code'] },
    ...
    '/api/geocoding':         { required: ['address'] },
    '/api/airquality':        { required: ['city'] },
    '/api/contract-risk':     { required: ['text'] },
    '/api/email-parse':       { required: ['email'] },
    '/api/domain-report':     { required: ['domain'] },
    '/api/seo-audit':         { required: ['url'] },
    '/api/lead-score':        { required: ['domain'] },
    '/api/crypto-intelligence': { required: ['token'] },
};

/**
 * Extract the inputSchema for a service URL by matching its pathname against _inputSchemaMap.
 * Services using anyOf patterns (twitter, github, table-insights) return null intentionally —
...
module.exports = { discoveryMap, generateDiscoveryForService, getInputSchemaForUrl };
