...
function getKey() {
    ...
    if (envKey && envKey.length === 64) {
        ...
        logger.warn('Credentials', 'CREDENTIALS_ENCRYPTION_KEY not set — using ephemeral key (credentials will be lost on restart)');
    }
    return _key;
}
...
module.exports = { encryptCredentials, decryptCredentials, maskCredentialValue, injectCredentials };
