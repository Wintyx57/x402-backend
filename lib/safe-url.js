...
const BLOCKED_HOST = /^(localhost|127\.|10\.|192\.168\.|172\.(1[6-9]|2\d|3[01])|0\.0\.0\.0|0\.|169\.254\.|\[?fc00:|\[?fe80:|\[?fd[0-9a-f]{2}:|::1|\[::1\]|\[::ffff:)/i;
...
const PRIVATE_IP_V4 = /^(127\.|10\.|192\.168\.|172\.(1[6-9]|2\d|3[01])\.|0\.|169\.254\.|0\.0\.0\.0)/;
