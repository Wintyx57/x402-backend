...
const ENDPOINTS = [
  ...
  // /api/image removed (no free upstream provider)
  ...
  { path: '/api/contract-risk', method: 'POST', label: 'Contract Risk Analyzer' },
  { path: '/api/code-review', method: 'POST', label: 'AI Code Review' },
  ...
  { path: '/api/email-parse', method: 'POST', label: 'Email CRM Parser' },
  { path: '/api/lead-score', method: 'GET', label: 'Lead Scoring' },
  { path: '/api/seo-audit', method: 'GET', label: 'SEO Audit' },
  { path: '/api/table-insights', method: 'POST', label: 'Table & CSV Insights' },
];
