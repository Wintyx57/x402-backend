...
// --- GEMINI EVALUATION ---
const GEMINI_SYSTEM = `You are an API response quality auditor. You MUST respond with ONLY a single JSON object, no other text before or after.

Evaluate the response on 5 dimensions (0-100 each):
...
Your response must be exactly this JSON format, nothing else:
